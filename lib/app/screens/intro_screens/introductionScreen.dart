            ...
            children: [
              ...
              IntroPage4(
                next: () async {
                  ...
                  await prefs.setString('empresa', nombreController.text);
                  await prefs.setString('slogan', sloganController.text);
                  ...
                  await prefs.setString('rfc', rfcController.text);
                  await prefs.setString('impuesto', "16");
